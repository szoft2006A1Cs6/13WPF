...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Nov 09. 21:12
...
INSERT INTO `kategoria` (`kategoriaId`, `nev`) VALUES
(1, 'Elektronika'),
(2, 'Könyvek'),
(3, 'Ruházat'),
(4, 'Konyha'),
...
INSERT INTO `rendeles` (`rendelesId`, `vasarloId`, `datum`, `osszeg`) VALUES
...
CREATE TABLE `rendelestetel` (
  `rendelestetelId` int(11) NOT NULL,
  `rendelesId` int(11) NOT NULL,
...
INSERT INTO `rendelestetel` (`rendelestetelId`, `rendelesId`, `termekId`, `mennyiseg`) VALUES
(1, 1, 1, 1),
(2, 1, 2, 1),
(3, 2, 4, 2);
...
INSERT INTO `termek` (`termekId`, `nev`, `leiras`, `ar`, `keszlet`, `kategoriaId`) VALUES
...
INSERT INTO `vasarlo` (`vasarloId`, `nev`, `email`, `cim`) VALUES
...
ALTER TABLE `rendelestetel`
  ADD PRIMARY KEY (`rendelestetelId`),
...
--
ALTER TABLE `rendelestetel`
  MODIFY `rendelestetelId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT a táblához `termek`
--
ALTER TABLE `termek`
  MODIFY `termekId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `rendelestetel`
  ADD CONSTRAINT `FK_rendelestetel_rendeles` FOREIGN KEY (`rendelesId`) REFERENCES `rendeles` (`rendelesId`),
  ADD CONSTRAINT `FK_rendelestetel_termek` FOREIGN KEY (`termekId`) REFERENCES `termek` (`termekId`);

--
-- Megkötések a táblához `termek`
--
ALTER TABLE `termek`
  ADD CONSTRAINT `FK_termek_kategoria` FOREIGN KEY (`kategoriaId`) REFERENCES `kategoria` (`kategoriaId`);
COMMIT;
